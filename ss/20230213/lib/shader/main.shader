...
[reflect]*/
	...
	//out_color = vec4(eye*0.5+0.5,1.0);
	//out_color = uvec4(floatBitsToUint(eye.rgb),1.0);
	out_color = uvec4(packHalf2x16(eye.rg),packHalf2x16(eye.br)
,packHalf2x16(vPos.rg),packHalf2x16(vPos.br));
